...
const Header = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 z-50 w-full border-b bg-background text-foreground">
        ...
        <div className="flex items-center justify-between h-16 px-4 mx-auto md:px-6 max-w-7xl">
          ...
          <div className="flex items-center gap-6">
            <Link to="/">
              <img src={kia} className="object-contain w-24" />
            </Link>
          ...
          <div className="flex-1 hidden max-w-xl mx-6 md:flex">
            <div className="flex w-full overflow-hidden border rounded-lg">
              <input
                ...
                className="flex-1 px-4 py-2 outline-none"
              />
              <button onClick={handleSearch} className="px-4 text-white bg-orange-400">
                <Search size={18} />
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            {/* CALL (desktop only) */}
            <button className="items-center hidden gap-2 px-4 py-2 text-sm text-white bg-orange-400 rounded-lg md:flex">
              <Phone size={16} />
              Call
            </button>
  ...
  <div className="flex items-center gap-3">
    ...
    <div
      onClick={() => navigate("/myProfile")}
      className="items-center hidden gap-1 text-sm font-medium cursor-pointer md:flex"
    >
      <User size={18} />
      {user?.userName || "Profile"}
      <ChevronDown size={14} />
        ...
        <div className="px-4 pb-3 md:hidden">
          <div className="flex overflow-hidden border rounded-lg">
            <input
              ...
              className="flex-1 px-4 py-2 outline-none"
            />
            <button onClick={handleSearch} className="px-4 text-white bg-black">
              <Search size={18} />
            </button>
          </div>
        </div>
