    ...
    <div className="w-full max-w-4xl px-3 py-4 mx-auto space-y-4 sm:px-4 md:px-6 sm:space-y-6 ">
      ...
      <div className="flex justify-end">
        <button
          ...
          className="px-4 sm:px-6 py-2 sm:py-2.5 text-sm sm:text-base font-medium text-white bg-gray-900 rounded-lg hover:bg-gray-700 active:scale-95 transition-all"
        >
          Create a Car
        </button>
      </div>
