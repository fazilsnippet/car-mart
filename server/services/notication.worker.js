...
//   finalUserSet.add(ADMIN_ID.toString());
//   break;
// }
...
//     phoneNumber: job.data.phoneNumber || null,
...
//       return "";
//     case "new-car-sell":
//       return `${data.title} (${data.year}) submitted`;
//       case "email-admin": {
...
const redisConnection = {
  host: process.env.REDIS_HOST,
  port: Number(process.env.REDIS_PORT), // ✅ FIXED
};
...
export const notificationWorker = new Worker(
  ...
  users.forEach((u) => finalUserSet.add(u._id.toString()));
  break;
}
